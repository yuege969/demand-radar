...
def calculate_pain_score(dimensions: dict) -> float:
    """Calculate weighted pain score from 6 dimensions.
    ...
    """
    total = (
        dimensions.get("emotion_intensity", 0) * 0.25
        + dimensions.get("repeat_frequency", 0) * 0.25
        + dimensions.get("involves_money", 0) * 0.25
